...
class Checkout extends Model
{
    ...
    protected $fillable=[
        'order_id','amount','user_id','full_name','phone','street','city','state','zip','country_code', 'port_code','order_status','payment_status','delivery_status', 'shipping_fee', 'platform_fee', 'total'
    ];
