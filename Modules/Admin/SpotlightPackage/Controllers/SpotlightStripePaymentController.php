...
class SpotlightStripePaymentController extends Controller
{
    // Create a Checkout Session
    public function createSpotlightCheckoutSession($purchase_id)
    {
        ...
        $packageData = Spotlight::where('id', $purchaseData->package_id)->first();
